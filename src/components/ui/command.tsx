...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-obsidian px-3" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-none px-2 py-1.5 text-base outline-none data-[disabled=true]:pointer-events-none data-[selected='true']:bg-candlelight data-[selected=true]:text-obsidian data-[disabled=true]:opacity-50",
      className,
    )}
    {...props}
  />
